...
function Dashboard(props) {
    ...
    return (
        <div className='grid grid-cols-12 gap-3'>
            ...
            <div className='col-span-12 text-4xl my-10 mx-auto'>Dashboard</div>

            <div className='col-span-4 text-4xl mb-10 mx-auto'>Tensão</div>
            <div className='col-span-4 text-4xl mb-10 mx-auto'>Corrente</div>
            <div className='col-span-4 text-4xl mb-10 mx-auto'>Potência</div>
